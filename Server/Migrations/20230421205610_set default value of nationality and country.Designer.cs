...
namespace CandidatePortal.Server.Migrations
{
    ...
    [Migration("20230421205610_set default value of nationality and country")]
    partial class setdefaultvalueofnationalityandcountry
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CandidatePortal.Shared.Entities.ApplicationQuestionnaire", b =>
                {
                    b.Property<long>("ERPRecId")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("ApplicationQuestionnaire", (string)null);
                });

            modelBuilder.Entity("CandidatePortal.Shared.Entities.ApplicationQuestionnaireLine", b =>
                {
                    b.Property<long>("ERPRecId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("AnswerErpRecId")
                        .HasColumnType("bigint");

                    b.Property<long>("ApplicationQuestionnaireErpRecId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ApplicationQuestionnaireErpRecId");

                    b.ToTable("ApplicationQuestionnaireLine", (string)null);
                });

            modelBuilder.Entity("CandidatePortal.Shared.Entities.ApplicationQuestionnaireLineAnswer", b =>
                {
                    b.Property<long>("ERPRecId")
                        .HasColumnType("bigint");

                    b.Property<long>("ApplicationQuestionnaireLineErpRecId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ApplicationQuestionnaireLineErpRecId");

                    b.ToTable("ApplicationQuestionnaireLineAnswer", (string)null);
                });
            ...
            modelBuilder.Entity("CandidatePortal.Shared.Entities.Candidate", b =>
                {
                    ...
                    b.Property<int?>("CanRelocate")
                        .HasColumnType("int");

                    b.Property<int?>("CanTravel")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CandidatePortal.Shared.Entities.CandidateCertificateType", b =>
                {
                    ...
                    b.Property<int?>("RenewalRequired")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CandidatePortal.Shared.Entities.ApplicationQuestionnaire", b =>
                {
                    b.HasOne("CandidatePortal.Shared.Entities.Application", null)
                        .WithMany("ApplicationQuestionnaire")
                        .HasForeignKey("ApplicationNumber")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CandidatePortal.Shared.Entities.ApplicationQuestionnaireLine", b =>
                {
                    b.HasOne("CandidatePortal.Shared.Entities.ApplicationQuestionnaire", null)
                        .WithMany("ApplicationQuestionnaireLine")
                        .HasForeignKey("ApplicationQuestionnaireErpRecId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CandidatePortal.Shared.Entities.ApplicationQuestionnaireLineAnswer", b =>
                {
                    b.HasOne("CandidatePortal.Shared.Entities.ApplicationQuestionnaireLine", null)
                        .WithMany("ApplicationQuestionnaireLineAnswer")
                        .HasForeignKey("ApplicationQuestionnaireLineErpRecId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CandidatePortal.Shared.Entities.Application", b =>
                {
                    ...
                    b.Navigation("ApplicationQuestionnaire");
                });
            ...
            modelBuilder.Entity("CandidatePortal.Shared.Entities.ApplicationQuestionnaire", b =>
                {
                    b.Navigation("ApplicationQuestionnaireLine");
                });

            modelBuilder.Entity("CandidatePortal.Shared.Entities.ApplicationQuestionnaireLine", b =>
                {
                    b.Navigation("ApplicationQuestionnaireLineAnswer");
                });
