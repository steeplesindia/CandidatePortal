...
namespace CandidatePortal.Server.Migrations
{
    ...
    [Migration("20220328092630_AppliedJobDate")]
    partial class AppliedJobDate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CandidatePortal.Shared.Entities.City", b =>
                {
                    ...
                    b.HasIndex("Code", "StateERPRecId", "DataArea")
                        .IsUnique();
            ...
            modelBuilder.Entity("CandidatePortal.Shared.Entities.State", b =>
                {
                    ...
                    b.HasIndex("Code", "CountryERPRecId", "DataArea")
                        .IsUnique();
            ...
            modelBuilder.Entity("CandidatePortal.Shared.Entities.City", b =>
                {
                    b.HasOne("CandidatePortal.Shared.Entities.State", null)
                        .WithMany("Cities")
                        .HasForeignKey("StateERPRecId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
